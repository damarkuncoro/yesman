...
/**
 * Handler untuk mendapatkan daftar semua route-feature mappings dengan detail feature
...
async function handleGetRouteFeatures(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    // Ambil semua route-feature mappings dengan detail feature
    const routeFeatures = await routeFeatureService.getAllRouteMappingsWithFeatures();
